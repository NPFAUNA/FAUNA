...
import { Calendar, MapPin, Clock, Heart, Facebook, ArrowRight, ExternalLink } from "lucide-react"

export const metadata: Metadata = {
  title: "Events",
  description:
    "Upcoming FAUNA events in Natchitoches, LA &mdash; adoption events, community health fairs, fundraisers, and more.",
}
...
const events: FaunaEvent[] = [
  ...
  },
  {
    ...
    category: "Adoption",
    description:
      "Meet available dogs and cats looking for their forever homes. All animals are spayed/neutered and vaccinated.",
  },
  {
    month: "OCT",
    day: "21",
    ...
    time: "6:00 PM",
    location: "Mariner's Restaurant",
    category: "Fundraiser",
    description:
      "Join us for FAUNA's Annual Farm to Table Dinner, a unique event benefiting Friends All United for Natchitoches Animals. Enjoy a skillfully prepared four-course dinner featuring local and regional products with wine pairings.",
    featured: true,
  },
]
...
const farmToTableSignupUrl = "https://FAUNAFarmToTable2026.eventbrite.com"
const farmToTableBrochureUrl = "/2026-farm-to-table-tri-fold.pdf"
    ...
    <main>
      ...
      <section className="bg-gradient-to-br from-green-900 to-green-800 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl sm:text-5xl font-extrabold mt-2 mb-4">
            Upcoming Events
          </h1>
          <p className="text-green-100 text-lg max-w-2xl">
            From adoption weekends to community health fairs, FAUNA hosts events throughout the year.
            Join us &mdash; every participant makes a difference.
          </p>
        </div>
      </section>
            ...
            {featured.map((event) => (
              ...
              >
                <div className="bg-green-800 text-white p-4 flex items-center gap-4">
                  ...
                  <div>
                    <Badge className={`${categoryColors[event.category]} text-xs mb-1`}>
                      {event.category}
                    </Badge>
                ...
                <CardContent className="p-5">
                  ...
                  {event.title === "Farm to Table Dinner" && (
                    <div className="flex flex-col gap-3">
                      <a
                        href={farmToTableSignupUrl}
                        target="_blank"
                      ...
                      <a
                        href={farmToTableBrochureUrl}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-center text-blue-600 hover:text-blue-800 font-semibold text-sm underline"
                      >
                        View the Farm to Table Brochure
                      </a>
                    </div>
                  )}
                </CardContent>
                  ...
                  <div className="flex items-start gap-5">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-wrap items-center gap-2 mb-1">
                        ...
                        <Badge className={`${categoryColors[event.category]} text-xs`}>
                          {event.category}
                        </Badge>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card className="border-0 shadow-lg">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600 text-sm leading-relaxed mb-4">
                  For the most up-to-date event announcements, adoptable animals,
                  and FAUNA news, follow us on Facebook. We post updates daily!
                </p>
            ...
            <Card className="border-0 shadow-lg">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600 text-sm leading-relaxed mb-4">
                  FAUNA events run on volunteer power. If you&apos;d like to help
                  set up, work the adoption table, or assist with health fair
                  activities, we&apos;d love your help!
                </p>
