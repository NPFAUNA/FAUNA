  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-[#0a1e3d] mb-6">
            ...
            {[
              {
                ...
                body: "Modern facilities for high-volume spay/neuter clinics and public vet services.",
              },
              {
                icon: "🎓",
        ...
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <div className="space-y-10">
            ...
            <div className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {["spaces1-1", "Spaces-2-2"].map((n) => (
                  <div key={n} className="rounded-xl overflow-hidden bg-sky-50">
                    <Image
                      src={`${BASE}/${n}.png`}
            ...
            <div className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm">
              ...
              <div className="rounded-xl overflow-hidden bg-sky-50 max-w-2xl mx-auto">
                <Image
            ...
            <div className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm">
              <div className="flex items-center justify-between flex-wrap gap-4 mb-6">
                <div className="text-left">
                  ...
                  <p className="font-semibold" style={{ color: "#5a9900" }}>
                    $300 - $12,000/year
                  </p>
                </div>
                <Link href="mailto:npfauna@gmail.com">
      ...
      <section className="py-12 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-2xl font-bold text-[#0a1e3d] mb-4">In the News</h2>
          <p className="text-gray-600 mb-6">
            Read more about the Edwina &amp; Sam Friedman Pet Adoption &amp; Welfare Center in the Natchitoches Parish
            Journal.
          </p>
          <Link
          ...
          >
            <Button variant="outline" className="border-[#0099FF] text-[#0099FF] hover:bg-sky-50">
              Read the Natchitoches Parish Journal Article
            </Button>
          </Link>
        </div>
      </section>
