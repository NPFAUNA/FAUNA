    ...
    <div className="min-h-screen">
      ...
      <section id="adopt" className="py-20 bg-white scroll-mt-16">
        <div className="max-w-5xl mx-auto px-4">
          ...
          {/* Shelterluv available pets embed */}
          <div className="mb-16" id="available-pets">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto mt-2">
                This list is powered by Shelterluv and updates automatically as pets become available.
              </p>
            </div>

            <div className="rounded-3xl overflow-hidden border border-sky-100 shadow-xl bg-white">
              <iframe
