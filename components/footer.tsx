  ...
  return (
    <footer className="bg-[#061424] text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-4 mb-5">
              ...
              <div>
                <span className="font-extrabold text-2xl block leading-tight">FAUNA</span>
                <span className="text-[#33CCCC] text-sm">
            ...
            <p className="text-sky-200/80 text-sm leading-relaxed mb-5 max-w-sm">
              ...
              animals in Natchitoches Parish, Louisiana &mdash; and finding every one of them a loving home.
            </p>
          ...
          {/* Links */}
          <div>
            <h4 className="font-semibold text-[#33CCCC] mb-4 uppercase text-xs tracking-widest">
              Navigation
            </h4>
            ...
            <ul className="space-y-2">
              {links.map((l) => (
                <li key={l.href}>
                  <Link
                    href={l.href}
                    className="text-sky-200/80 hover:text-white text-sm transition-colors"
                  >
                    {l.label}
                  </Link>
                </li>
        ...
        <div className="border-t border-[#0d2851] mt-10 pt-6 flex flex-col sm:flex-row justify-between items-center gap-2 text-xs text-sky-200/50">
